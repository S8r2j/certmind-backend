...
async def chat_message(
    ...
    system_prompt = (
        ...
        "4. NEVER include URLs, hyperlinks, or web addresses of any kind. You cannot verify whether "
        "a URL exists or is accurate, so do not generate them. Instead, refer to resources by their "
        "exact official name (e.g. 'the AWS Well-Architected Framework whitepaper', "
        "'the official AWS Cloud Practitioner exam guide', 'AWS documentation for IAM') "
        "so the student can search for them directly.\n\n"
